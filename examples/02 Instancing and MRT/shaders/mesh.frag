...
layout(binding = 4) uniform sampler2DArray   s_textures;
layout(binding = 5) uniform samplerCubeArray s_cubemaps;

layout(location = 0) uniform vec3  cam_pos;
layout(location = 1) uniform int   show_pass;
layout(location = 2) uniform float fcoef;
...
layout(location = 4) smooth in float flogz;
